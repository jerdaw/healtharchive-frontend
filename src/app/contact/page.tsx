            ...
            <section className="ha-home-hero space-y-6">
                <div className="ha-grid-2 gap-4 sm:gap-5">
                    ...
                    <div className="ha-card ha-home-panel p-4 sm:p-5 space-y-3">
                        ...
                        <p className="text-sm sm:text-base leading-relaxed text-ha-muted">
                            The frontend you are viewing is open source. If
                            you&apos;re comfortable with GitHub, you can watch
                            the repository to follow changes.
                        </p>
                        ...
                        <p className="text-xs sm:text-sm text-ha-muted leading-relaxed">
                            Contributions are welcome, particularly from people
                            with experience in web archiving, public health, or
                            accessible interface design. Please open an issue
                            first to discuss substantial changes.
                        </p>
                    </div>
                </div>
            </section>
