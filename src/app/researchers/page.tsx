    ...
    >
      <section className="ha-home-hero space-y-5">
        ...
        <ul className="text-ha-muted list-disc space-y-1 pl-5 text-sm leading-relaxed sm:text-base">
          <li>
            <strong>Policy and guideline history:</strong> Tracking how public health guidance on
            subjects such as COVID-19 vaccination, seasonal influenza, or naloxone distribution has
            changed over time.
          </li>
          <li>
            <strong>Reproducibility of analyses:</strong> Linking analytic work to the exact wording
            and tables visible on a given date, rather than relying on whatever the current version
            of a page shows.
          </li>
          <li>
      ...
      <section className="ha-home-hero ha-home-hero-plain space-y-5">
        ...
        <p className="ha-section-subtitle ha-section-lede leading-relaxed">
          The archive explorer and snapshot viewer are designed to support research workflows, but
          the interface is still evolving. Coverage is expanding, and some pages may be missing or
          incomplete.
        </p>
        <ul className="text-ha-muted list-disc space-y-1 pl-5 text-sm leading-relaxed sm:text-base">
          <li>Keyword search with filters by source.</li>
          <li>A pages view (latest capture per URL) and a snapshots view (all captures).</li>
          <li>A “browse by source” view summarizing coverage for each source.</li>
          <li>Snapshot detail pages with capture metadata and the archived HTML when available.</li>
          <li>
            Change tracking and compare views that highlight descriptive text differences between
            archived captures.
          </li>
        </ul>
        <p className="text-ha-muted text-sm leading-relaxed sm:text-base">
          If you need bulk access, reproducible exports, or specific capture coverage for a study,
      ...
      <section className="ha-home-hero ha-home-hero-plain space-y-5">
        ...
        <p className="ha-section-subtitle ha-section-lede leading-relaxed">
          HealthArchive provides metadata-only exports for research. Exports do not include raw HTML
          or full diff bodies.
        </p>
      ...
      <section className="ha-home-hero ha-home-hero-plain space-y-5">
        ...
        <p className="ha-section-subtitle ha-section-lede leading-relaxed">
          Citation guidance is available on the cite page. A pragmatic format for referencing an
          archived page from HealthArchive.ca is:
        </p>
        <p className="text-ha-muted text-sm leading-relaxed sm:text-base">
          See{" "}
        ...
        <p className="text-ha-muted text-sm leading-relaxed sm:text-base">
          Snapshot URLs in the live archive typically use a numeric ID (as in the example above).
          When citing, use the exact snapshot URL and capture date/time shown on the snapshot detail
          page you accessed.
        </p>
        <p className="text-ha-muted text-sm leading-relaxed sm:text-base">
          When citing a comparison, include both snapshot URLs (A and B), their capture dates, and
          the HealthArchive compare URL.
        </p>
      </section>
      ...
      <section className="ha-home-hero ha-home-hero-plain space-y-4">
        <div className="ha-callout">
          ...
          <ul className="mt-2 list-disc space-y-1 pl-5 text-xs leading-relaxed sm:text-sm">
            <li>Versioned dataset releases (monthly or quarterly) with checksums.</li>
            <li>Larger custom exports prepared offline for specific studies or course projects.</li>
          </ul>
