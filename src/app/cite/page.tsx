  ...
  return (
    ...
    >
      ...
      <section className="ha-home-hero ha-home-hero-plain space-y-5">
        ...
        <p className="ha-section-subtitle ha-section-lede leading-relaxed">Recommended format</p>
        ...
        <p className="text-ha-muted text-sm leading-relaxed sm:text-base">Example</p>
        <div className="ha-card ha-home-panel space-y-1 p-4 text-xs text-slate-800 sm:p-5 sm:text-sm">
      ...
      <section className="ha-home-hero ha-home-hero-plain space-y-5">
        ...
        <p className="ha-section-subtitle ha-section-lede leading-relaxed">
          Compare views highlight descriptive text differences between two archived captures of the
          same page.
        </p>
        <div className="ha-card ha-home-panel space-y-1 p-4 text-xs text-slate-800 sm:p-5 sm:text-sm">
        ...
        <ul className="text-ha-muted list-disc space-y-1 pl-5 text-sm leading-relaxed sm:text-base">
          ...
          <li>Record both snapshot IDs and the capture timestamps shown on the compare page.</li>
        </ul>
      </section>
      ...
      <section className="ha-home-hero ha-home-hero-plain space-y-4">
        <div className="ha-callout">
          ...
          <p className="mt-2 text-xs leading-relaxed sm:text-sm">
            On <span className="font-medium text-slate-800">/snapshot/&lt;id&gt;</span> you can find
            the page title, capture date/time (UTC), source organization, original URL, and the
            snapshot URL.
          </p>
          <p className="mt-3 text-xs leading-relaxed sm:text-sm">
            ...
            you can find both snapshot IDs, both capture timestamps (UTC), the original URL, and a
