    ...
    >
      <section className="ha-home-hero space-y-4">
        ...
        <p className="text-sm sm:text-base leading-relaxed text-ha-muted">
          HealthArchive.ca is intended for research, journalism, education, and
          historical reference. Use archived content to cite what was published
          at a specific time, not as a substitute for current official guidance.
        </p>
      ...
      <section className="ha-home-hero ha-home-hero-plain space-y-4">
        ...
        <p className="text-sm sm:text-base leading-relaxed text-ha-muted">
          Archived content may be incomplete, outdated, or superseded. Nothing
          on this site should be interpreted as medical advice or current
          clinical guidance.
        </p>
      </section>
      ...
      <section className="ha-home-hero ha-home-hero-plain space-y-4">
        ...
        <p className="text-sm sm:text-base leading-relaxed text-ha-muted">
          When referencing archived content, include the capture date, original
          URL, and the HealthArchive snapshot link. See the researchers page for
          a citation example.
        </p>
        <p className="text-sm sm:text-base leading-relaxed text-ha-muted">
          <Link
      ...
      <section className="ha-home-hero ha-home-hero-plain space-y-4">
        ...
        <p className="text-sm sm:text-base leading-relaxed text-ha-muted">
          The archive is provided on an as-is basis. We do our best to maintain
          access, but availability, completeness, and replay fidelity can vary.
        </p>
      </section>
      ...
      <section className="ha-home-hero ha-home-hero-plain space-y-4">
        <div className="ha-callout">
          ...
          <p className="mt-2 text-xs leading-relaxed sm:text-sm">
            If you spot a metadata error or a broken replay, submit a report so
            we can review it. For other questions, use the contact page.
          </p>
